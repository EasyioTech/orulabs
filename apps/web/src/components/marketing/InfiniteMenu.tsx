...
class ArcballControl {
  ...
  snapTargetDirection: any;
  EPSILON = 0.1;
  IDENTITY_QUAT = quat.create();
  canvas: HTMLCanvasElement;
  updateCallback: Function;
  pointerPos: any;
  previousPointerPos: any;
  _rotationVelocity = 0;
  _combinedQuat = quat.create();

  constructor(canvas: HTMLCanvasElement, updateCallback: Function) {
    this.canvas = canvas;
  ...
  quatFromVectors(a: any, b: any, out: any, angleFactor = 1) {
...
class InfiniteGridMenu {
  ...
  constructor(canvas: HTMLCanvasElement, items: any[], onActiveItemChange: Function, onMovementChange: Function, onInit: Function | null = null, scale = 1.0) {
    this.canvas = canvas;
    this.items = items || [];
  ...
  init(onInit: Function | null) {
    ...
    this.control = new ArcballControl(this.canvas, (deltaTime: number) => this.onControlUpdate(deltaTime));
        ...
        item =>
          new Promise((resolve) => {
            ...
            img.onerror = () => {
              ...
              // Create a fallback colored canvas so it doesn't hang
              ...
              if (fCtx) {
                ...
                fCtx.fillStyle = '#cbd5e1'; // slate-300
                fCtx.font = 'bold 48px sans-serif';
                fCtx.textAlign = 'center';
                fCtx.textBaseline = 'middle';
                fCtx.fillText('OruClass', 256, 256);
              }
              resolve(fallback);
            };
            img.src = item.image;
